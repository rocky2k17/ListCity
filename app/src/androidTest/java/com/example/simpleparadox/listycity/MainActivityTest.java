...
public class MainActivityTest {
    ...
    public void testing() {
        ...
        solo_MainActivity.enterText((EditText) solo_MainActivity.getView(R.id.editText_name), "1707114");
        solo_MainActivity.clickOnButton("CONFIRM");
        solo_MainActivity.waitForText("Edmonton", 1, 2000);

        solo_MainActivity.clickOnButton("ADD CITY");
        solo_MainActivity.enterText((EditText) solo_MainActivity.getView(R.id.editText_name), "Fuad");
        solo_MainActivity.clickOnButton("CONFIRM");
        solo_MainActivity.waitForText("Edmonton", 1, 2000);


        // Access the variables and methods
        ...
        String city = (String) cityList.getItemAtPosition(0); // Get the item from first position
        // checking if roll number is the first city
        assertEquals("1707114", city);
        ...
        // Check if return to MainActivity successfully
        solo_MainActivity.assertCurrentActivity("this is not MainActivity", MainActivity.class);
